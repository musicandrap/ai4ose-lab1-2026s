...
考核指标1~3的总体介绍来自[`tg-rcore-tutorial` crate](https://crates.io/crates/tg-rcore-tutorial)中的`练习任务`中的内容，仓库位于 https://github.com/rcore-os/tg-rcore-tutorial 。

考核指标1~3的具体内容来自`tg-rcore-tutorial-ch[1..8]`crates 中的`练习任务`中的内容。可在 https://crates.io/crates/tg-rcore-tutorial-ch-[1..8] 的网址中看到，对应git 仓库位于 https://github.com/rcore-os/tg-rcore-tutorial-ch[1..8]/tree/test 。
...
2. 个性化实验教程设计（20%）  
   充分利用各类AI工具，基于附录中的“最新教学实验教程”，结合自身兴趣与学习需求，设计并实现一个个性化的操作系统内核教学实验教程。可参考附录中的最新教学实验教程内容并进行改进、扩展、裁剪、重构，或者自己从零构建，形成自己的个性化教学实验教程。需提交一份设计总结报告，内容包括：  
   - 设计思路与目标（包括适合自己的学习方式描述，初步设想和规划等）
   - 与AI合作的实现过程（包括如何与AI交互，碰到的问题/bug、解决过程等）
   - 学习效果评估（包括自己在这个学习过程中知识和能力的提升/下降评价，与本校现有教学实验教程的定量/定性的对比分析）

3. 扩展实验实践（20%）  
   充分利用各类AI工具，设计实现ch1~ch8的游戏应用，并基于并扩展ch1~ch8内核，以支持ch1~ch8的游戏应用的新内核，夯实操作系统理论基础并提升实践能力和创造能力，最终提交一份包含与AI合作的实现过程与学习收获的总结报告，内容包括：    
   - 与AI合作的实现过程（包括如何与AI交互，碰到的问题/bug、解决过程等）
   - 学习效果评估（包括自己在这个学习过程中知识和能力的提升/下降评价，与本校现有教学实验教程的定量/定性的对比分析）
